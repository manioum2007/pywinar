...
class Winars(wx.Frame):
    def __init__(self,titre):
        ...
        self.Bind(wx.EVT_LIST_ITEM_RIGHT_CLICK,self.OnList,self.lit)
        self.Bind(wx.EVT_LIST_ITEM_SELECTED, self.OnSelect, self.lit)
    ...
    def Menu(self):
        ...
        commande.Append(-1, '&Ajoute des Fichiers l archive \tCtrl+O','Ajoute des Fichiers l archive')
        ...
        commande.Append(-1, '&Imprimer Fichier\tAlt+A','Ajouter un commentaire')
        ...
        options.Append(-1, '&Parametres...','Parametres...')
